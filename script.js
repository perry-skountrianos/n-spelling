...
const letterStrokes = {
    ...
    'b': ['M 20,5 L 20,108', 'M 20,58 C 20,36 82,36 82,70 C 82,104 20,108 20,82'],
    'c': ['M 82,32 C 62,15 15,22 15,58 C 15,90 52,100 82,86'],
    'd': ['M 80,58 C 80,36 18,36 18,70 C 18,104 80,108 80,82', 'M 80,5 L 80,108'],
    ...
    'g': ['M 80,52 C 80,26 60,18 48,18 C 26,18 16,36 16,58 C 16,80 28,98 50,98 C 70,98 80,82 80,58', 'M 80,58 L 80,108 C 80,124 60,130 38,120'],
...
const modeIcons = {
    ...
    choose:   '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#666" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>',
    sentence: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#666" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h16"/><path d="M4 12h10"/><path d="M4 17h12"/></svg>',
    qa:       '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#666" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>',
    alphabet: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#666" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20 L10 4 L16 20"/><path d="M6.5 14 L13.5 14"/><path d="M17 8 Q22 8 22 13 Q22 18 17 18 L17 8"/></svg>',
};

function updateHomeIcon(mode) {
    const el = document.getElementById('homeCircleIcon');
    if (el && modeIcons[mode]) el.innerHTML = modeIcons[mode];
}
